...
export class Backend implements backendInterface {
    ...
    async assignFirstAdmin(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.assignFirstAdmin();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllNewsletterSubscribers(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: number, arg7: bigint): Promise<string> {
        if (this.processError) {
            try {
